    ...
    <Html>
      ...
      <Body style={main}>
        <Container style={container}>
          <Img
            src={`${process.env.NEXT_PUBLIC_SERVER_URL}/nextE-commerce-logos.jpeg`}
            width="150"
            height="150"
            alt="e-commerce"
            style={logo}
          ...
          <Text style={paragraph}>
            Welcome to next.E-commerce, the marketplace for high quality digital
